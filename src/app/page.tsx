...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000]">
      <div className="flex h-full justify-center">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            <h1 className="text-green-400 text-3xl font-semibold hidden md:flex">
              Sorting Visualizer
            </h1>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  <RxReset className="text-gray-500 h-8 w-8" />
                ) : (
            ...
            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div className="flex w-full text-gray-100 p-4 rounded border border-gray-200 bg-gray-800 bg-opacity-90 gap-6">
          ...
          <div className="relative h-[calc(100vh-66px)] w-full">
            <div className="absolute bottom-[32px] w-full mx-auto left-0 right-0 flex justify-center items-end">
              {arrayToSort.map((value, index) => (
                <div
                  key={index}
                  className="array-line relative w-1 mx-0.5 shadow-lg opacity-80 rounded-lg bg-gray-500"
